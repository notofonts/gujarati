 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, canadian-aboriginal, coptic, malayalam, math, tifinagh, old-permic, tai-le
 ...
 * U+0951 DEVANAGARI STRESS SIGN UDATTA: try adding one of: grantha, sharada, tirhuta, devanagari, telugu
 * U+0952 DEVANAGARI STRESS SIGN ANUDATTA: try adding one of: devanagari, tirhuta, grantha, telugu
 * U+2010 HYPHEN: try adding one of: sora-sompeng, syloti-nagri, coptic, sundanese, cham, kaithi, kharoshthi, lisu, yi, kayah-li
...
Your font does *not* cover the following languages that require the soft-dotted feature: Kom (Latn, 360,685 speakers), Aghem (Latn, 38,843 speakers), Igbo (Latn, 27,823,640 speakers), Avokaya (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Koonzime (Latn, 40,000 speakers), Dutch (Latn, 31,709,104 speakers), Nateni (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ejagham (Latn, 120,000 speakers), Navajo (Latn, 166,319 speakers), Ebira (Latn, 2,200,000 speakers), Basaa (Latn, 332,940 speakers), Ma’di (Latn, 584,000 speakers), Dan (Latn, 1,099,244 speakers), Ukrainian (Cyrl, 29,273,587 speakers). [code: soft-dotted]
